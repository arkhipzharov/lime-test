> Написание текста для этого файла в процессе. Он включен в репозиторий для того, чтобы дать приблизительное представление о том, как будут выглядеть оеименовани в дальнейшем
## Именование классов
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc5Njk2ODY1LC0xNjA0MTg0OTAsLTEzMD
Y4OTYyNDEsLTE3MzA0MDkyNjAsNTQwNzQ3MTk1XX0=
-->